...
الأحد: 10:00 صباحاً - 4:00 مساءً',
  ...
  array (
    ...
    'car_not_available_for_booking' => 'هذه السيارة غير متاحة للحجز.',
    'car_not_available_selected_dates' => 'هذه السيارة غير متاحة في التواريخ المحددة.',
    'car_documents_expired' => 'لا يمكن حجز هذه السيارة لأن الرخصة أو التأمين منتهي.',
    'choose_another_date_range' => 'يرجى اختيار فترة أخرى.',
  ...
  array (
    ...
    array (
      ...
      'guest' => 'زائر',
      'inactive' => 'غير نشط',
      'locked_by_plan' => 'مقفل بسبب الخطة',
      'employee_locked_by_plan' => 'تم قفل حسابك مؤقتًا لأن حد موظفي خطة الشركة تم تخفيضه.',
      'branch_locked_by_plan' => 'تم قفل فرعك مؤقتًا لأن حد فروع خطة الشركة تم تخفيضه.',
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          'locked_booking_requests_notice' => ':count طلبات حجز مقفلة بسبب حد الخطة الحالي. تبقى بيانات العملاء مخفية حتى تسمح الخطة بمزيد من الحجوزات.',
          'locked_booking_requests_title' => 'طلبات الحجز المقفلة',
          'locked_booking_requests_hidden' => 'بيانات العميل مخفية حتى تسمح الخطة بمزيد من الحجوزات.',
          'locked_booking_requests_reveal_hint' => 'الخطة الحالية تسمح بعرض بيانات هذه الطلبات.',
          'convert_locked_booking_request' => 'تحويل إلى حجز',
        ),
      ),
      'roles' => 
      array (
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          'add_vehicle_model' => 'إضافة موديل سيارة',
          'save_a_model_and_its_default_specifications_for_this_tenant_only' => 'احفظ موديلًا ومواصفاته الافتراضية لهذا التيننت فقط.',
          'e_g_tucson' => 'مثال: Tucson',
          'save_model' => 'حفظ الموديل',
          'vehicle_model_saved_successfully' => 'تم حفظ موديل السيارة بنجاح.',
          'vehicle_model_creation_failed' => 'فشل إنشاء موديل السيارة.',
          'description' => 'الوصف',
      ...
      array (
        ...
        'edit' =>
        array (
          'head_title' => 'تعديل عميل',
          'title' => 'تعديل عميل',
          'back' => 'رجوع',
          'back_to_client' => 'العودة للعميل',
          'client_details' => 'تفاصيل العميل',
          'description' => 'تحديث بيانات حساب العميل.',
          'full_name' => 'الاسم الكامل *',
          'client_name_placeholder' => 'اسم العميل',
          'email' => 'البريد الإلكتروني *',
          'email_placeholder' => 'client@example.com',
          ...
          'password_help' => 'اتركها فارغة للإبقاء على كلمة المرور الحالية.',
