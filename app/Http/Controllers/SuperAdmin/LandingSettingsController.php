...
class LandingSettingsController extends Controller
{
    ...
    private function defaultTranslationRows(string $locale): array
    {
        ...
        $rows = array_merge($rows, [
            ...
            'booking_confirmation.payment_paid_title' => 'Payment completed',
            'booking_confirmation.payment_paid_message' => 'Your payment was received successfully and your booking is confirmed.',
            'booking_confirmation.payment_pending_title' => 'Payment pending',
            'booking_confirmation.payment_pending_message' => 'Your booking was received, but the payment is still pending. We will update the booking once the payment provider confirms it.',
            'booking_confirmation.payment_cancelled_title' => 'Payment cancelled',
            'booking_confirmation.payment_cancelled_message' => 'The payment was cancelled and this booking is not confirmed.',
            'booking_confirmation.payment_failed_title' => 'Payment failed',
            'booking_confirmation.payment_failed_message' => 'We could not confirm your payment. Please try again or contact support.',
            'security_access.device_limit.title' => 'Device Login Limit',
            'security_access.device_limit.description' => 'Limit how many active devices each user can use. Existing devices stay active; new devices are blocked when the limit is reached.',
            'security_access.device_limit.enable' => 'Enable Limit',
            'security_access.device_limit.super_admin_excluded' => 'Super Admin users are always excluded.',
            'security_access.device_limit.max_devices' => 'Max Devices per User',
            'security_access.device_limit.recommended' => 'Recommended starting value: 2.',
            'security_access.device_limit.apply_to' => 'Apply To',
            'security_access.device_limit.all_tenant_users' => 'All tenant users',
            'security_access.device_limit.tenant_admins' => 'Tenant admins',
            'security_access.device_limit.clients' => 'Clients',
            'security_access.device_limit.reached' => 'Device limit reached. Please contact the administrator to remove an old device.',
            'security_access.device_limit.revoked' => 'This device has been revoked. Please log in again.',
            'dashboard.admin.clients.devices.title' => 'Registered Devices',
            'dashboard.admin.clients.devices.description' => 'Revoking a device removes its API tokens and frees a slot for a new login.',
            'dashboard.admin.clients.devices.device' => 'Device',
            'dashboard.admin.clients.devices.source' => 'Source',
            'dashboard.admin.clients.devices.last_used' => 'Last Used',
            'dashboard.admin.clients.devices.unknown_device' => 'Unknown device',
            'dashboard.admin.clients.devices.revoke' => 'Revoke',
            'dashboard.admin.clients.devices.revoke_confirmation' => 'Revoke this device?',
            'dashboard.admin.clients.devices.empty' => 'No registered devices yet.',
            ...
            'dashboard.admin.reservation_statuses.awaiting_payment' => 'Awaiting Payment',
            ...
            'client_pages.layout.nav.back_to_site' => 'Back to website',
            'client_pages.layout.nav.profile' => 'My details',
            'client_pages.profile.head_title' => 'My details',
            'client_pages.profile.title' => 'My details',
            'client_pages.profile.subtitle' => 'Update your personal contact information.',
            'client_pages.profile.card_title' => 'Profile information',
            'client_pages.profile.card_description' => 'These details are used for your bookings and rental documents.',
            'client_pages.profile.full_name' => 'Full Name',
            'client_pages.profile.email' => 'Email Address',
            'client_pages.profile.civil_number' => 'Civil Number',
            'client_pages.profile.phone' => 'Phone Number',
            'client_pages.profile.whatsapp' => 'WhatsApp Number',
            'client_pages.profile.optional' => 'optional',
            'client_pages.profile.saving' => 'Saving...',
            'client_pages.profile.save_changes' => 'Save Changes',
            'booking.car_not_available_for_booking' => 'This car is not available for booking.',
            'booking.car_not_available_selected_dates' => 'This car is not available for the selected dates.',
            'booking.car_documents_expired' => 'This car cannot be booked because its license or insurance has expired.',
            'booking.choose_another_date_range' => 'Please choose another date range.',
            'dashboard.admin.clients.create.phone' => 'Phone Number *',
            'dashboard.admin.clients.create.phone_placeholder' => 'Phone number',
            'dashboard.admin.clients.create.whatsapp' => 'WhatsApp Number (optional)',
            'dashboard.admin.clients.create.whatsapp_placeholder' => 'WhatsApp number',
            'dashboard.admin.clients.edit.head_title' => 'Edit Client',
            'dashboard.admin.clients.edit.title' => 'Edit Client',
            'dashboard.admin.clients.edit.back' => 'Back',
            'dashboard.admin.clients.edit.back_to_client' => 'Back to client',
            'dashboard.admin.clients.edit.client_details' => 'Client details',
            'dashboard.admin.clients.edit.description' => 'Update this client account details.',
            'dashboard.admin.clients.edit.full_name' => 'Full Name *',
            'dashboard.admin.clients.edit.client_name_placeholder' => 'Client name',
            'dashboard.admin.clients.edit.email' => 'Email *',
            'dashboard.admin.clients.edit.email_placeholder' => 'client@example.com',
            'dashboard.admin.clients.edit.civil_number' => 'Civil Number *',
            'dashboard.admin.clients.edit.civil_number_placeholder' => 'Civil number',
            'dashboard.admin.clients.edit.phone' => 'Phone Number *',
            'dashboard.admin.clients.edit.phone_placeholder' => 'Phone number',
            'dashboard.admin.clients.edit.whatsapp' => 'WhatsApp Number (optional)',
            'dashboard.admin.clients.edit.whatsapp_placeholder' => 'WhatsApp number',
            'dashboard.admin.clients.edit.branch' => 'Branch',
            'dashboard.admin.clients.edit.no_branch' => 'No branch',
            'dashboard.admin.clients.edit.password' => 'New Password',
            'dashboard.admin.clients.edit.password_help' => 'Leave blank to keep the current password.',
            'dashboard.admin.clients.edit.confirm_password' => 'Confirm New Password',
            'dashboard.admin.clients.edit.saving' => 'Saving...',
            'dashboard.admin.clients.edit.save_changes' => 'Save Changes',
            'dashboard.admin.clients.edit.cancel' => 'Cancel',
