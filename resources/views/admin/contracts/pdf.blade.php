...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .serial { margin-top: 8px; font-size: 12px; }
        .serial span { color: #d6202a; font-size: 18px; font-weight: 900; }
        ...
        .ack-text { font-size: 7px; line-height: 1.22; }
        .important { margin-top: 5px; font-size: 8px; line-height: 1.2; }
        ...
        <table class="bordered">
            <tr>
                <td class="cell" style="width: 50%;">
                    ...
                    <table class="inline-fields"><tr>
                        <td class="inline-label">Sponsor</td><td class="inline-value">{{ $lineValue($primaryDriver?->sponsor) }}</td><td class="ar inline-label">الكفيل</td>
                        <td class="inline-label">Exp. Date</td><td class="inline-value"></td><td class="ar inline-label">تاريخ الانتهاء</td>
                    </tr></table>
                ...
                <td class="cell" style="width: 50%;">
                    ...
                    <table class="inline-fields"><tr>
                        <td class="inline-label">Visa No</td><td class="inline-value">{{ $lineValue($visaNumber) }}</td><td class="ar inline-label">رقم التأشيرة :</td>
                        <td class="inline-label">Exp. Date</td><td class="inline-value">{{ $lineValue($visaExpiry) }}</td><td class="ar inline-label">تاريخ الانتهاء</td>
                    </tr></table>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" class="cell">
                    ...
                    <table class="inline-fields period">
                        <tr><td class="inline-label">Return Time</td><td class="inline-value">{{ $returnTime }}</td><td class="ar inline-label">وقت العودة :</td><td class="inline-label">To</td><td class="inline-value">{{ $returnDate }}</td><td class="ar inline-label">إلى :</td><td class="inline-label">From</td><td class="inline-value">{{ $pickupDate }}</td><td class="ar inline-label">من :</td></tr>
                        <tr><td class="inline-label" colspan="2">Quantity of gasoline in the car at the time of delivery</td><td class="inline-value" colspan="4">{{ $lineValue($contract->vehicle_fuel_level) }}</td><td class="ar inline-label" colspan="3">كمية البنزين الموجودة بالسيارة وقت الاستلام</td></tr>
                        <tr><td class="inline-label">Out Mileage</td><td class="inline-value">{{ $lineValue($contract->vehicle_odometer) }}</td><td class="ar inline-label">الكيلومترات عند المغادرة :</td><td class="inline-label">Out Time</td><td class="inline-value">{{ $pickupTime }}</td><td class="ar inline-label">وقت المغادرة :</td><td class="inline-label">Out Date</td><td class="inline-value">{{ $pickupDate }}</td><td class="ar inline-label">تاريخ المغادرة :</td></tr>
                        <tr><td class="inline-label">Return Mileage</td><td class="inline-value">{{ $lineValue($contract->return_odometer) }}</td><td class="ar inline-label">الكيلومترات عند العودة :</td><td class="inline-label">Return Time</td><td class="inline-value">{{ $actualReturnTime ? $actualReturnTime->format('H:i') : '' }}</td><td class="ar inline-label">وقت العودة :</td><td class="inline-label">Return Date</td><td class="inline-value">{{ $actualReturnTime ? $actualReturnTime->format('Y-m-d') : '' }}</td><td class="ar inline-label">تاريخ العودة :</td></tr>
                        <tr><td class="inline-label">Return Fuel</td><td class="inline-value">{{ $lineValue($contract->return_fuel_level) }}</td><td class="ar inline-label">الوقود عند العودة :</td><td colspan="6"></td></tr>
                    </table>
                </td>
            </tr>
            <tr class="rules">
