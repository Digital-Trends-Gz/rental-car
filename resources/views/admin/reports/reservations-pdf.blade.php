...
@php
    ...
    $safeReportNumber = $reportNumber ?? 'RES-'.now()->format('Ymd-Hi');
@endphp
...
<div class="page">
    <table class="document-header">
        <tr>
            ...
            <td class="head-main">
                ...
                <div class="title-line">RESERVATIONS REPORT <span class="ar">تقرير الحجوزات</span></div>
            </td>
    ...
    <div class="section">
        <div class="section-title">
            Reservations Summary <span class="ar">| ملخص الحجوزات</span>
        </div>
        <table class="data-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="ar">إجمالي الحجوزات</td>
                    <td class="metric-value">{{ $reservationsReport['summary']['total'] }}</td>
                </tr>
                <tr>
                    <td>Confirmed</td>
                    <td class="ar">الحجوزات المؤكدة</td>
                    <td class="metric-value">{{ $reservationsReport['summary']['confirmed'] }}</td>
                </tr>
                <tr>
                    <td>Canceled</td>
                    <td class="ar">الحجوزات الملغاة</td>
                    <td class="metric-value">{{ $reservationsReport['summary']['canceled'] }}</td>
                </tr>
                <tr>
                    <td>No Show</td>
                    <td class="ar">No Show</td>
                    <td class="metric-value">{{ $reservationsReport['summary']['no_show'] }}</td>
                </tr>
                <tr>
                    <td>Completed</td>
                    <td class="ar">الحجوزات المكتملة</td>
                    <td class="metric-value">{{ $reservationsReport['summary']['completed'] }}</td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="section">
        <div class="section-title">
            Key Performance Indicators <span class="ar">| مؤشرات الأداء الرئيسية</span>
        </div>
        <table class="data-table">
            <thead>
                <tr>
            ...
            <tbody>
                <tr>
                    <td>Average Value</td>
                    <td class="ar">متوسط قيمة الحجز</td>
                    <td class="metric-value">{{ $reservationsReport['kpis']['average_value']['formatted'] }}</td>
                </tr>
                <tr>
                    <td>Cancellation Rate</td>
                    <td class="ar">نسبة الإلغاء</td>
                    <td class="metric-value">{{ $reservationsReport['kpis']['cancellation_rate']['formatted'] }}</td>
                </tr>
                <tr>
                    <td>No-Show Rate</td>
                    <td class="ar">نسبة No Show</td>
                    <td class="metric-value">{{ $reservationsReport['kpis']['no_show_rate']['formatted'] }}</td>
                </tr>
            </tbody>
        </table>
    </div>
