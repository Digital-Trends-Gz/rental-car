...
const pageTitle = computed(() => localize('Plate Format Templates', 'قوالب أنماط اللوحات'));
const pageDescription = computed(() =>
    localize(
        'Define the default plate formats available to all tenants. Tenants can still add their own custom formats.',
        'عرّف أنماط اللوحات الافتراضية المتاحة لجميع المستأجرين. يمكن للمستأجرين إضافة أنماطهم الخاصة أيضًا.',
    ),
);
            ...
            <form class="space-y-6" @submit.prevent="submit">
                <Card>
                    ...
                    <CardContent class="space-y-4">
                        ...
                        <div v-for="(format, index) in form.settings.plate_formats" :key="format.key" class="rounded-lg border p-4">
                            <div class="flex items-center justify-between gap-4">
                            ...
                            <div class="mt-4 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <Input :id="`plate-format-country-${index}`" v-model="format.country" :placeholder="localize('OM', 'OM')" />
