...
<template>
    <Head :title="localize('Create Discount', 'إنشاء خصم', 'ڈسکاؤنٹ بنائیں')" />
    <SuperAdminLayout>
        <main class="flex-1 p-8 space-y-6">
            <div class="flex items-center gap-4">
                ...
                <h1 class="text-2xl font-semibold">{{ localize('Create Subscription Discount', 'إنشاء خصم للاشتراك', 'سبسکرپشن ڈسکاؤنٹ بنائیں') }}</h1>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="flex gap-2">
                    <Button type="submit" :disabled="form.processing">
                        {{ form.processing ? localize('Creating...', 'جارٍ الإنشاء...', 'بنایا جا رہا ہے...') : localize('Create Discount', 'إنشاء خصم', 'ڈسکاؤنٹ بنائیں') }}
                    </Button>
                    <Link href="/superadmin/discounts">
